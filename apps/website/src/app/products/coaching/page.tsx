...
import { Zap, ArrowRight, PlayCircle, Check, TimerOff, UserMinus, Package, MessageSquare, Bot, Moon, TrendingUp, ShieldCheck, Quote, Sparkles } from 'lucide-react';
    ...
    <main className="flex-grow bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-slate-100 antialiased overflow-x-hidden">
        ...
        <div className="max-w-full mx-auto px-6 md:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-10 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all group shadow-xl">
              <TimerOff size={48} className="text-blue-500 mb-8 group-hover:scale-110 transition-transform block" />
            ...
            <div className="p-10 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all group shadow-xl">
              <UserMinus size={48} className="text-blue-500 mb-8 group-hover:scale-110 transition-transform block" />
            ...
            <div className="p-10 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all group shadow-xl">
              <Package size={48} className="text-blue-500 mb-8 group-hover:scale-110 transition-transform block" />
      ...
      <section className="py-40 bg-zinc-950 relative">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-10">
          <Quote size={80} className="text-blue-500/40 mb-12 mx-auto select-none" />
