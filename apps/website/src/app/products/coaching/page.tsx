...
export const metadata = {
  ...
  description:
    'Turn your knowledge into an automated customer attraction machine with Intervision AI.'
}
    ...
    <main className="flex-grow bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-slate-100 antialiased overflow-x-hidden">
        ...
        <div className="max-w-full mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-500 text-sm font-bold mb-8 animate-fade-in-up">
              <Zap size={14} /> AI SOLUTIONS FOR COACHES & FREELANCERS
            </div>
            <h1 className="text-5xl md:text-7xl font-black leading-tight tracking-tight text-slate-900 dark:text-white mb-8">
              Turn Knowledge into an{' '}
              <span className="text-blue-500">Automated Machine</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              AI systems help coaches and freelancers screen high-quality
              students and schedule appointments 24/7 without hours of manual
              chatting.
            </p>
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-6 font-bold">
              <button
                type="button"
                className="bg-blue-600 text-white px-10 py-5 rounded-2xl text-lg hover:bg-blue-700 hover:scale-105 transition-all  shadow-blue-500/20 shadow-neon flex items-center justify-center gap-2"
              >
                Create Coaching Funnel <ArrowRight size={20} />
              </button>
              <button
                type="button"
                className="bg-white/5 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white px-10 py-5 rounded-2xl text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-2"
              >
          ...
          <div
            className="flex-1 relative animate-fade-in-up"
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-xs mt-1">
                      AI automatically screened & scheduled at 14:00.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-full mx-auto px-6 md:px-12">
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              Common roadblocks holding your coaching business back.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-10 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all group shadow-xl">
              <TimerOff
                size={48}
                className="text-blue-500 mb-8 group-hover:scale-110 transition-transform block"
              />
              <h3 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">
                Wrong Prospects
              </h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Spending hours chatting with people who don't have real needs or
                sufficient budget to invest in your coaching.
              </p>
            </div>
            <div className="p-10 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all group shadow-xl">
              <UserMinus
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Lack of follow-up systems and value delivery causes leads to
                drop off immediately after receiving a quote.
              </p>
            </div>
            <div className="p-10 rounded-[2rem] bg-white dark:bg-zinc-900 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all group shadow-xl">
              <Package
              ...
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                Manual information collection makes your professional image look
                amateur to high-end, premium students.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-zinc-900 rounded-[3rem] overflow-hidden border border-white/10 shadow-3xl flex flex-col md:flex-row min-h-[600px]">
            <div className="p-12 md:p-20 flex-1 flex flex-col justify-center">
              <h2 className="text-4xl font-black text-white mb-6">
                Experience the AI Student Screening Funnel
              </h2>
              <p className="text-slate-400 text-lg mb-10 leading-relaxed">
                Try our automated process that qualifies and categorizes leads
                in under 60 seconds.
              </p>
              <button
                type="button"
                className="bg-blue-600 text-white w-fit px-8 py-4 rounded-xl font-bold hover:bg-blue-700 transition-all flex items-center gap-3 shadow-xl shadow-blue-600/20"
              >
                Start Demo Chat <MessageSquare size={20} />
              </button>
            </div>
            <div className="flex-1 bg-zinc-800/40 p-8 md:p-12 border-l border-white/5 backdrop-blur-md">
              <div className="bg-zinc-950 rounded-2xl border border-white/10 h-full min-h-[400px] flex flex-col overflow-hidden shadow-2xl">
                <div className="p-4 border-b border-white/10 bg-white/5 flex items-center gap-3">
                  ...
                  <span className="text-xs text-slate-500 ml-auto font-medium tracking-widest uppercase">
                    AI Assistant
                  </span>
                </div>
                <div className="flex-1 p-8 space-y-8 h-[400px] overflow-y-auto">
                  ...
                  <div
                    className="flex flex-col items-end gap-3 animate-fade-in-up"
                  ...
                  <div
                    className="flex flex-wrap gap-2 pt-4 px-14 animate-fade-in-up"
                    style={{ animationDelay: '3s' }}
                  >
                    <div className="px-5 py-2 border-2 border-blue-500/30 rounded-full text-xs font-bold text-blue-500 bg-blue-500/5 cursor-pointer hover:bg-blue-500 hover:text-white transition-all">
                      Under 10M VND
                    </div>
                    <div className="px-5 py-2 border-2 border-blue-500/30 rounded-full text-xs font-bold text-blue-500 bg-blue-500/5 cursor-pointer hover:bg-blue-500 hover:text-white transition-all">
                      10 - 50M VND
          ...
          <div className="grid md:grid-cols-3 gap-16">
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                AI works for you even while you sleep, responding to customers
                immediately when they show interest.
              </p>
            </div>
            <div className="flex flex-col items-center text-center group">
              <div className="size-20 rounded-3xl bg-blue-500/10 flex items-center justify-center mb-8 group-hover:bg-blue-500/20 transition-all transform group-hover:rotate-6 shadow-xl shadow-blue-500/5">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                Focus your precious time only on working with those who are
                truly serious and qualified.
              </p>
            </div>
            <div className="flex flex-col items-center text-center group">
              <div className="size-20 rounded-3xl bg-blue-500/10 flex items-center justify-center mb-8 group-hover:bg-blue-500/20 transition-all transform group-hover:rotate-6 shadow-xl shadow-blue-500/5">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                Smooth, automated processes create a professional impression and
                differentiate you from noise.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-40 bg-zinc-950 relative">
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle at 2px 2px, #256af4 1px, transparent 0)',
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12 text-center relative z-10">
          <Quote
            size={80}
            className="text-blue-500/40 mb-12 mx-auto select-none"
          />
          <p className="text-3xl md:text-5xl font-medium text-white italic leading-tight mb-16 tracking-tight">
            "Intervision completely changed the way I work. I save over 15 hours
            every week just by automating the screening phase. Now I only open
            Zoom when meeting the right people who are ready to pay."
          </p>
      ...
      <section className="py-40">
        <div className="max-w-full mx-auto px-6 md:px-12">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-[3rem] p-16 md:p-32 text-center relative overflow-hidden shadow-neon animate-fade-in-up">
            ...
            <h2 className="text-4xl md:text-7xl font-black text-white mb-10 relative z-10 tracking-tight">
              Ready to Automate Your <br className="hidden md:block" /> Coaching
              Business?
            </h2>
            <p className="text-white/80 text-xl mb-16 max-w-2xl mx-auto relative z-10 leading-relaxed font-medium">
              Start today to optimize your customer attraction process and focus
              on creating real value for your students.
            </p>
            <button
              type="button"
              className="bg-white text-blue-600 px-12 py-6 rounded-2xl font-black text-2xl hover:bg-slate-100 hover:scale-105 transition-all shadow-3xl relative z-10 transform active:scale-95"
            >
              Start for Free Now
            </button>
          </div>
