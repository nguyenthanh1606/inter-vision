...
export const metadata = {
  ...
  description: 'Breakthrough E-commerce revenue with artificial intelligence and automated sales optimization.',
};
    ...
    <main className="flex-grow bg-zinc-950 text-slate-100 antialiased overflow-x-hidden">
      ...
      <section className="relative px-6 md:px-12 pt-40 pb-24 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        <div className="lg:col-span-12 xl:col-span-5 space-y-10 group">
          ...
          <h1 className="text-5xl md:text-8xl font-black leading-[0.95] tracking-tighter">
            Breakthrough <br/>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-blue-600">E-commerce with AI.</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-400 max-w-lg leading-relaxed font-medium">
            Elevate customer experience and optimize sales processes with smart operation systems from Intervision Prism.
          </p>
          <div className="flex flex-wrap gap-6 pt-4 font-bold">
            <button className="bg-blue-600 hover:bg-blue-500 text-white px-10 py-5 rounded-2xl text-xl shadow-2xl shadow-blue-600/30 shadow-neon active:scale-95 transition-all">
              Boost Conversion Rates
            </button>
            <button className="bg-white/5 backdrop-blur-xl border border-white/10 hover:bg-white/10 text-white px-10 py-5 rounded-2xl text-xl transition-all">
              Watch Demo
            </button>
          </div>
        </div>
        ...
        <div className="lg:col-span-12 xl:col-span-7 relative animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-white/5 backdrop-blur-3xl rounded-[3rem] border border-white/10 p-10 shadow-3xl relative z-10 overflow-hidden transform hover:scale-[1.02] transition-transform duration-700">
            <div className="flex items-center justify-between mb-10">
              ...
              <div className="text-xs font-black tracking-[0.3em] text-slate-500 uppercase">Prism Dashboard v2.4</div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
              <div className="bg-zinc-900/50 p-6 rounded-3xl border border-white/5 shadow-inner group hover:border-blue-500/30 transition-colors">
                <div className="text-slate-500 text-xs font-black uppercase tracking-widest mb-2">Total Leads</div>
                <div className="text-3xl font-black text-white">12,842</div>
                <div className="text-blue-500 text-[10px] font-bold mt-3 tracking-widest">+14.2% AI BOOST</div>
              </div>
              <div className="bg-zinc-900/50 p-6 rounded-3xl border border-white/5 shadow-inner group hover:border-blue-500/30 transition-colors">
                <div className="text-slate-500 text-xs font-black uppercase tracking-widest mb-2">Conversion</div>
                <div className="text-3xl font-black text-white">4.82%</div>
                <div className="text-blue-400 text-[10px] font-bold mt-3 tracking-widest">+0.9% RECOVERY</div>
              </div>
              <div className="bg-zinc-900/50 p-6 rounded-3xl border border-white/5 shadow-inner group hover:border-blue-500/30 transition-colors">
                <div className="text-slate-500 text-xs font-black uppercase tracking-widest mb-2">Orders</div>
                <div className="text-3xl font-black text-white">1,409</div>
                <div className="text-blue-300 text-[10px] font-bold mt-3 tracking-widest">+22% CHATBOT</div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between p-5 bg-white/5 rounded-2xl border border-white/5 shadow-xl transform transition-all hover:translate-x-2">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500 font-bold mt-0.5 uppercase tracking-widest">Processed by AI Agent</div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-5 bg-white/5 rounded-2xl border border-white/5 opacity-60 shadow-xl transform transition-all hover:translate-x-2">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500 font-bold mt-0.5 uppercase tracking-widest">Chatbot responding...</div>
                  </div>
                </div>
                <div className="text-[10px] bg-blue-500/20 text-blue-400 px-3 py-1 rounded-full font-black tracking-widest">ACTIVE</div>
              </div>
            </div>
      ...
      <section className="px-6 md:px-12 py-40 max-w-7xl mx-auto">
        <div className="mb-24 text-center max-w-2xl mx-auto">
          <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight tracking-tighter">Comprehensive Solutions <br/> for <span className="text-blue-500">Growth</span></h2>
          <p className="text-xl text-slate-400 font-medium leading-relaxed">Leverage the power of AI to automate every touchpoint in your customer's shopping journey.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 bg-white/5 backdrop-blur-3xl rounded-[3rem] p-12 border border-white/10 group hover:border-blue-500/30 transition-all duration-700 overflow-hidden relative shadow-3xl">
            <div className="flex flex-col h-full justify-between relative z-10">
              ...
              <div className="mt-12 flex gap-4">
                <span className="px-5 py-2 bg-blue-500/10 text-blue-500 text-xs font-black rounded-full border border-blue-500/20 tracking-widest uppercase">Native NLP</span>
                <span className="px-5 py-2 bg-blue-500/10 text-blue-500 text-xs font-black rounded-full border border-blue-500/20 tracking-widest uppercase">Visual Search</span>
              </div>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-3xl rounded-[3rem] p-12 border border-white/10 hover:border-blue-500/30 transition-all duration-700 flex flex-col justify-between shadow-3xl group">
            ...
            <div className="bg-zinc-950 p-6 rounded-3xl mt-12 border border-white/5 shadow-inner">
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-xs font-black uppercase tracking-widest text-slate-500">Trending for Client</span>
              </div>
              <div className="flex -space-x-3">
                <div className="size-16 rounded-2xl bg-zinc-800 border-2 border-zinc-950 shadow-2xl"></div>
                <div className="size-16 rounded-2xl bg-zinc-800 border-2 border-zinc-950 shadow-2xl"></div>
                <div className="size-16 rounded-2xl bg-blue-600/30 border-2 border-zinc-950 flex items-center justify-center text-sm font-black text-blue-500 backdrop-blur-md">+3</div>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-3 bg-white/5 backdrop-blur-3xl rounded-[3rem] p-12 lg:p-20 border border-white/10 flex flex-col md:flex-row items-center gap-20 group shadow-3xl hover:border-blue-500/30 transition-all duration-700">
            <div className="flex-1">
              <div className="inline-flex px-4 py-1.5 rounded-full bg-blue-500/20 text-blue-400 text-[10px] font-black tracking-[0.3em] uppercase mb-8">RECOVERY ENGINE</div>
              <h3 className="text-4xl md:text-5xl font-black mb-8 leading-tight tracking-tighter">Abandoned Cart Recovery <br className="hidden lg:block"/> via Conversational AI</h3>
            ...
            <div className="w-full md:w-2/5 aspect-[4/5] rounded-[3rem] overflow-hidden bg-zinc-900 flex items-center justify-center relative border border-white/5 shadow-2xl">
              ...
              <div className="relative z-10 bg-zinc-950/80 backdrop-blur-2xl p-8 rounded-[2rem] border border-white/20 shadow-3xl transform rotate-2">
                <div className="text-base font-black italic text-white">"Forgot this item? <br/> Final 10% off inside!"</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 md:px-12 py-40 bg-zinc-900/50 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-24 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight tracking-tighter">Measure the <br className="hidden md:block"/> <span className="text-blue-500 underline decoration-4 underline-offset-8">ROI Impact</span></h2>
            <p className="text-slate-400 text-xl font-medium leading-relaxed mb-12">
              Projections for exponential revenue growth when applying Intervision Prism solutions to your current E-commerce operations.
            </p>
          ...
          <div className="lg:w-1/2 w-full animate-fade-in-up">
            <div className="bg-white/5 backdrop-blur-3xl p-12 md:p-16 rounded-[4rem] border border-blue-500/20 shadow-3xl relative overflow-hidden transform hover:-rotate-1 transition-transform">
              ...
              <div className="text-center mb-12">
                ...
                <div className="text-4xl md:text-6xl font-black text-blue-500 tracking-tighter">+185,000,000 VND<span className="text-xl ml-2 font-black text-slate-500">/mo</span></div>
              </div>
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-zinc-950 p-6 rounded-3xl text-center border border-white/5 shadow-inner">
                  <div className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-2">CONVERSION LIFT</div>
                  <div className="text-3xl font-black text-blue-400">~ 22%</div>
                </div>
                <div className="bg-zinc-950 p-6 rounded-3xl text-center border border-white/5 shadow-inner">
                  <div className="text-[10px] text-slate-500 uppercase font-black tracking-widest mb-2">COST SAVED</div>
                  <div className="text-2xl font-black text-blue-300">~ 15M VND</div>
                </div>
              </div>
              <button className="w-full mt-12 bg-white text-zinc-950 font-black py-6 rounded-2xl text-xl hover:bg-blue-500 hover:text-white transition-all transform active:scale-95 shadow-2xl">
      ...
      <section className="px-6 md:px-12 py-40 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h2 className="text-5xl md:text-8xl font-black mb-12 leading-[0.95] tracking-tighter animate-fade-in-up">Ready to Lead the <br className="hidden md:block"/> E-commerce Market?</h2>
          <p className="text-xl md:text-2xl text-slate-400 mb-20 max-w-2xl mx-auto leading-relaxed font-medium">Join 500+ premium brands skyrocketing their global sales with Intervision AI.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-10 font-black">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-14 py-6 rounded-2xl text-2xl active:scale-95 transition-all shadow-3xl shadow-blue-600/40">
              Start for Free Now
            </button>
