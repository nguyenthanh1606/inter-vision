...
export const metadata = {
  ...
  description: 'Automate lead classification and collection for real estate brokers 24/7 with Intervision AI.',
};
    ...
    <main className="flex-grow bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-slate-100 antialiased">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="flex flex-col gap-8">
              ...
              <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tight text-slate-900 dark:text-white">
                Automate Lead Classification for <span className="text-[#ec5b13]">Real Estate</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-xl leading-relaxed">
                AI systems help brokers capture customer real estate needs 24/7 without missing any opportunities.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-[#ec5b13] hover:scale-105 transition-transform text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-lg shadow-[#ec5b13]/20 shadow-neon">
                  Start for Real Estate
                </button>
                <button className="bg-white/5 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 hover:bg-white/10 text-slate-900 dark:text-white px-8 py-4 rounded-2xl font-bold text-lg transition-all">
                  Watch Demo
                </button>
              </div>
            </div>
              ...
              <div className="absolute -bottom-8 -left-8 bg-white dark:bg-zinc-900 p-8 rounded-3xl shadow-2xl border border-[#ec5b13]/10 hidden md:block animate-fade-in-up">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-3xl font-black text-slate-900 dark:text-white">+24 Prospects</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-32 bg-white/50 dark:bg-white/5 border-y border-slate-200 dark:border-white/10">
        <div className="max-w-full mx-auto px-6 md:px-12 text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-black mb-6">Major Challenges for Brokers</h2>
        ...
        <div className="max-w-full mx-auto px-6 md:px-12 grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-zinc-900/50 p-10 rounded-3xl border border-slate-200 dark:border-white/10 border-b-4 border-b-[#ec5b13] hover:-translate-y-2 transition-transform shadow-xl">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Customers often search for properties outside of business hours, leading to delayed responses and losing leads to competitors.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900/50 p-10 rounded-3xl border border-slate-200 dark:border-white/10 border-b-4 border-b-[#ec5b13] hover:-translate-y-2 transition-transform shadow-xl">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Processing hundreds of spam messages or low-budget leads before finding serious buyers who are ready to commit.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900/50 p-10 rounded-3xl border border-slate-200 dark:border-white/10 border-b-4 border-b-[#ec5b13] hover:-translate-y-2 transition-transform shadow-xl">
            ...
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
              Customer information is scattered across platforms, making it hard to manage and track long-term consultation progress.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black mb-6">Experience 24/7 AI Consultation</h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg">
              Simulate how Intervision AI interacts with your potential customers.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-zinc-900 border border-[#ec5b13]/20 rounded-[2.5rem] shadow-2xl overflow-hidden max-w-md mx-auto transform hover:scale-[1.02] transition-transform">
            ...
            <div className="p-8 space-y-6 h-[480px] overflow-y-auto bg-slate-50 dark:bg-zinc-950">
              ...
              <div className="flex justify-end animate-fade-in-up" style={{ animationDelay: '1s' }}>
              ...
              {/* Quiz Options */}
              <div className="pl-12 flex flex-wrap gap-2 animate-fade-in-up" style={{ animationDelay: '3s' }}>
                <button className="px-4 py-2 rounded-xl border border-[#ec5b13] text-[#ec5b13] text-xs font-bold hover:bg-[#ec5b13] hover:text-white transition-all">Under 5 Billion VND</button>
                <button className="px-4 py-2 rounded-xl border border-[#ec5b13] text-[#ec5b13] text-xs font-bold hover:bg-[#ec5b13] hover:text-white transition-all">5 - 10 Billion VND</button>
                <button className="px-4 py-2 rounded-xl border border-[#ec5b13] text-[#ec5b13] text-xs font-bold hover:bg-[#ec5b13] hover:text-white transition-all">Over 10 Billion VND</button>
              </div>
            </div>
        ...
        <div className="max-w-full mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 text-center">
            <div className="animate-fade-in-up">
              <div className="text-6xl font-black mb-3 tracking-tighter">40%</div>
              <div className="text-white/80 font-bold uppercase text-xs tracking-[0.2em]">Increase Closing Rate</div>
            </div>
            <div className="animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              <div className="text-6xl font-black mb-3 tracking-tighter">15h</div>
              <div className="text-white/80 font-bold uppercase text-xs tracking-[0.2em]">Hours Saved Weekly</div>
            </div>
            <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              <div className="text-6xl font-black mb-3 tracking-tighter">100%</div>
              <div className="text-white/80 font-bold uppercase text-xs tracking-[0.2em]">Leads Responded To</div>
            </div>
            <div className="animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              <div className="text-6xl font-black mb-3 tracking-tighter">24/7</div>
              <div className="text-white/80 font-bold uppercase text-xs tracking-[0.2em]">Non-stop Operation</div>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
              ...
              <div>
                <p className="text-2xl md:text-3xl font-medium italic mb-8 leading-relaxed text-slate-800 dark:text-slate-100">
                  "Since using Intervision AI, I no longer worry about late-night messages. AI helps me pre-filter customers with matching budgets, so I just need to call and schedule viewings. It saves so much time!"
                </p>
                <div>
                  <h4 className="text-2xl font-black text-[#ec5b13]">Mr. Hoang Nam</h4>
                  <p className="text-slate-500 font-bold uppercase tracking-widest text-sm mt-1">Sales Director at Luxury Home Vietnam</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="pb-40 relative px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center bg-white/5 dark:bg-white/5 backdrop-blur-3xl py-24 rounded-[4rem] border border-slate-200 dark:border-white/10 shadow-3xl overflow-hidden relative">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-8 leading-tight">Ready to Skyrocket Your <br className="hidden md:block"/> Real Estate Revenue?</h2>
          <p className="text-xl text-slate-600 dark:text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed">
            Join over 500+ brokers and real estate agencies leading the market with AI technology.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <button className="bg-[#ec5b13] hover:scale-105 hover:bg-[#ec5b13]/90 text-white px-12 py-5 rounded-2xl font-black text-xl transition-all shadow-xl shadow-[#ec5b13]/30 shadow-neon">
              Start for Free Now
            </button>
            <button className="bg-transparent border-2 border-[#ec5b13]/20 hover:border-[#ec5b13] text-slate-900 dark:text-white px-12 py-5 rounded-2xl font-black text-xl transition-all">
              Contact 1-1
            </button>
          </div>
        </div>
