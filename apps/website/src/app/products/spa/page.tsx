import { CalendarX2, Clock, Frown } from 'lucide-react'
import Image from 'next/image'

export const metadata = {
  title: 'AI Solutions for Spas & Aesthetics | Intervision',
  description:
    'Comprehensive AI solutions helping Spas and Aesthetics Clinics increase conversion rates and customer retention 24/7.'
}
        ...
        >
          <div className="flex flex-col gap-4 max-w-[800px] z-10 animate-fade-in-up">
            <span className="text-primary font-bold tracking-wider uppercase text-sm">
              AI Solutions for Spas & Aesthetics Clinics
            </span>
            ...
            <p className="text-slate-200 text-lg font-normal leading-relaxed @[480px]:text-xl max-w-[640px] mx-auto">
              Comprehensive AI solutions helping Spas and Aesthetics Clinics
              increase conversion rates and customer retention 24/7 without
              additional staff.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 z-10">
            <button
              type="button"
              className="flex min-w-[160px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-8 bg-primary hover:bg-blue-600 transition-all text-white text-base font-bold shadow-lg shadow-blue-500/30"
            >
              <span className="truncate">Start for Your Spa</span>
            </button>
            <button
              type="button"
              className="flex min-w-[160px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-12 px-8 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 transition-all text-white text-base font-bold"
            >
      ...
      <div className="layout-content-container flex flex-col max-w-[1200px] mx-auto px-4 py-16 gap-12">
        <div className="flex flex-col items-center text-center gap-4">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg font-normal leading-relaxed max-w-[720px]">
            Don't lose potential customers over slow responses. Intervision
            solves the biggest pain points for Spa owners.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="group flex flex-col gap-6 rounded-2xl border border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark p-8 hover:border-primary/50 transition-all duration-300">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed">
                Customers waiting too long will go to competitors. 70% of
          ...
          <div className="group flex flex-col gap-6 rounded-2xl border border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark p-8 hover:border-primary/50 transition-all duration-300">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed">
                Manual management through messages leads to confusion, double
                bookings, and an unprofessional experience.
              </p>
            </div>
          </div>
          {/* Card 3 */}
          <div className="group flex flex-col gap-6 rounded-2xl border border-slate-200 dark:border-border-dark bg-white dark:bg-surface-dark p-8 hover:border-primary/50 transition-all duration-300">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed">
                Lack of follow-up after customers leave reduces return rates and
                new referrals.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-[1000px] mx-auto px-4 py-20 flex flex-col gap-10">
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              AI will automatically suggest the right script based on customer
              preferences.
            </p>
          </div>
          <div className="bg-slate-50 dark:bg-background-dark border border-slate-200 dark:border-border-dark rounded-2xl p-6 md:p-10 shadow-2xl">
            ...
            <div className="space-y-4">
              <label className="group flex items-center gap-4 rounded-xl border border-slate-200 dark:border-border-dark bg-white/50 dark:bg-surface-dark/50 p-4 hover:border-primary hover:bg-white dark:hover:bg-surface-dark transition-all cursor-pointer">
                <div className="relative flex items-center justify-center">
                  <input
                    defaultChecked
                    className="peer h-5 w-5 border-2 border-slate-300 dark:border-slate-600 bg-transparent text-primary focus:ring-primary focus:ring-offset-0 checked:border-primary cursor-pointer appearance-none rounded-full checked:bg-primary"
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-slate-600 dark:text-slate-400 text-sm">
                    Consultation on acne, pigmentation, and skin rejuvenation
                    treatments
                  </span>
                </div>
              </label>
              <label className="group flex items-center gap-4 rounded-xl border border-slate-200 dark:border-border-dark bg-white/50 dark:bg-surface-dark/50 p-4 hover:border-primary hover:bg-white dark:hover:bg-surface-dark transition-all cursor-pointer">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-slate-600 dark:text-slate-400 text-sm">
                    Fat reduction for abdomen, thighs, and body toning packages
                  </span>
                </div>
              </label>
              <label className="group flex items-center gap-4 rounded-xl border border-slate-200 dark:border-border-dark bg-white/50 dark:bg-surface-dark/50 p-4 hover:border-primary hover:bg-white dark:hover:bg-surface-dark transition-all cursor-pointer">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-slate-600 dark:text-slate-400 text-sm">
                    Safe, painless Laser Diode technology
                  </span>
                </div>
              </label>
            </div>
            <div className="mt-8 pt-6 border-t border-slate-200 dark:border-border-dark flex flex-col md:flex-row gap-4 justify-between items-center">
              ...
              <button
                type="button"
                className="w-full md:w-auto px-6 py-2.5 rounded-lg bg-primary hover:bg-blue-600 text-white font-bold text-sm transition-colors"
              >
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-20">
        <div className="flex flex-col lg:flex-row gap-12 items-center rounded-3xl bg-gradient-to-br from-white dark:from-surface-dark to-slate-50 dark:to-background-dark border border-slate-200 dark:border-border-dark p-8 md:p-12">
          <div className="flex-1 flex flex-col gap-6">
            ...
            <h2 className="text-slate-900 dark:text-white text-3xl md:text-4xl font-bold leading-tight">
              'Intervision helped us increase{' '}
              <span className="text-primary">revenue by 30%</span> after only 2
              months of implementation.'
            </h2>
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
              Previously, receptionists were often overloaded during peak hours,
              leading to missed customer messages. With Intervision, every
              message is responded to immediately, and appointments are
              automatically scheduled into available time slots.
            </p>
            <div className="flex flex-col gap-4 mt-2">
              <div className="flex items-center gap-4">
                <div className="flex flex-col">
                  <strong className="text-slate-900 dark:text-white text-xl">
                    Ms. Thu Hoài
                  </strong>
                  <span className="text-slate-600 dark:text-slate-400 text-sm">
                    Founder, Lotus Spa
      ...
      <div className="bg-slate-50 dark:bg-background-dark py-24 text-center border-t border-slate-200 dark:border-border-dark">
        <div className="max-w-[1200px] mx-auto px-4">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg mb-10 max-w-[600px] mx-auto">
            Sign up today to receive free consultation and experience the power
            of AI in Spa operational management.
          </p>
          <button
            type="button"
            className="inline-flex min-w-[200px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-14 px-8 bg-primary hover:bg-primary-hover transition-all text-white text-lg font-bold shadow-lg shadow-blue-500/20 hover:shadow-blue-500/40"
          >
            Start for Your Spa
          </button>
