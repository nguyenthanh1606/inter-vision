...
export default function FloatingButtons() {
  ...
  return (
    <div className={styles.floating}>
      <a href="tel:0941818616" className={`${styles.btn} ${styles.call}`} title={t("call")}>
      ...
      <a href="#popup-dlh" className={`${styles.btn} ${styles.appointment}`} title={t("appointment")}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <Link href="/contact" className={`${styles.btn} ${styles.address}`} title={t("address")}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
