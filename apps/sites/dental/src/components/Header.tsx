  ...
  const menuItems = [
    {
      ...
      children: [
        {
          label: t('menu.gioiThieu_veIDent'),
          href: '/about/about-i-dent' as const
        },
        {
          label: t('menu.gioiThieu_tsbs'),
          href: '/about/dr-nguyen-hieu-tung' as const
        },
        {
          label: t('menu.gioiThieu_doiNgu'),
          href: '/about/dental-team' as const
        },
        {
          label: t('menu.gioiThieu_camKet'),
          href: '/about/quality-commitment' as const
        },
        {
          label: t('menu.gioiThieu_taiSao'),
          href: '/about/why-choose-us' as const
        },
        { label: t('menu.gioiThieu_coSo'), href: '/about/facilities' as const },
        {
          label: t('menu.gioiThieu_doiTac'),
          href: '/about/about-i-dent' as const
        }
      ]
    },
    {
      ...
      children: [
        {
          label: t('menu.implant_bangGia'),
          href: '/pricing/implants' as const
        },
        {
          label: t('menu.implant_congNghe'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.implant_toanHam'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.implant_phacDo'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.implant_vietKieu'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.implant_khachHang'),
    ...
    },
    {
      ...
      children: [
        ...
        {
          label: t('menu.bocSu_thamMy'),
          href: '/services/dental-crowns' as const
        },
        {
          label: t('menu.bocSu_veneer'),
          href: '/services/dental-crowns' as const
        },
        {
          label: t('menu.bocSu_khachHang'),
          href: '/patient-stories/implants' as const
        }
      ]
    },
    {
      ...
      children: [
        {
          label: t('menu.niengRang_bangGia'),
          href: '/pricing/implants' as const
        },
        {
          label: t('menu.niengRang_thamMy'),
          href: '/services/orthodontics' as const
        }
      ]
    },
    {
      ...
      children: [
        {
          label: t('menu.dichVu_tramRang'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.dichVu_caoVoi'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.dichVu_tayTrang'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.dichVu_nhoRang'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.dichVu_nhoRangKhon'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.dichVu_viemTuy'),
          href: '/services/dental-implants' as const
        },
        {
          label: t('menu.dichVu_taoHinh'),
          href: '/services/dental-implants' as const
        }
      ]
    },
    {
      ...
      children: [
        ...
        {
          label: t('menu.uuDai_niengRang'),
          href: '/pricing/implants' as const
        },
        {
          label: t('menu.uuDai_dichVuKhac'),
          href: '/pricing/implants' as const
        }
      ]
    },
    {
      ...
      children: [
        {
          label: t('menu.khachHang_implant'),
          href: '/patient-stories/implants' as const
        },
        {
          label: t('menu.khachHang_bocSu'),
          href: '/patient-stories/implants' as const
        },
        {
          label: t('menu.khachHang_niengRang'),
          href: '/patient-stories/implants' as const
        }
      ]
    },
    { label: t('menu.tinTuc'), href: '/knowledge/news' as const },
    {
      ...
      children: [
        ...
        {
          label: t('menu.kienThuc_niengRang'),
          href: '/knowledge/news' as const
        },
        ...
        <div className={styles.topBarInner}>
          ...
          <div className={styles.topRight}>
            <a href="tel:0941818616" className={styles.hotline}>
              ...
              <span className={styles.hotlineNumber}>
                {tc('hotlineNumber')}
              </span>
            </a>
            <button
