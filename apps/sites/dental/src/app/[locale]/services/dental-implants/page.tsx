        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.sidebarWidget}>
            ...
            <ul className={styles.sidebarLinks}>
              ...
              <li>
                <Link href="/pricing/implants">{t('sidebarImplant3')}</Link>
              </li>
              <li>
          ...
          <div className={styles.sidebarWidget}>
            ...
            <ul className={styles.sidebarLinks}>
              <li>
                <Link href="/services/dental-crowns">{t('sidebarOther1')}</Link>
              </li>
              <li>
                <Link href="/services/orthodontics">{t('sidebarOther2')}</Link>
              </li>
              <li>
                <Link href="/services/dental-crowns">{t('sidebarOther3')}</Link>
              </li>
            </ul>
          </div>
        </div>
