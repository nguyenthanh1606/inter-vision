        ...
        <div className={styles.mainContent}>
          ...
          <table className={styles.priceTable}>
            ...
            <tbody>
              ...
              <tr>
                <td>Implant Straumann SLActive</td>
                <td>Thụy Sĩ</td>
                <td className={styles.priceHighlight}>
          ...
          <table className={styles.priceTable}>
            <thead>
              <tr>
                <th>{t('thCrown')}</th>
                <th>{t('thCrownPrice')}</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>Mão sứ Zirconia</td>
              ...
              <tr>
                <td>Mão sứ Cercon</td>
                <td className={styles.priceHighlight}>5.000.000 – 7.000.000</td>
              </tr>
            </tbody>
          </table>
          ...
          <table className={styles.priceTable}>
            <thead>
              <tr>
                <th>{t('thMethod')}</th>
                <th>{t('thFullArchPrice')}</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>All-on-4 (1 hàm)</td>
                <td className={styles.priceHighlight}>
                  120.000.000 – 180.000.000
                </td>
              </tr>
              <tr>
                <td>All-on-6 (1 hàm)</td>
                <td className={styles.priceHighlight}>
        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.sidebarWidget}>
            ...
            <ul className={styles.sidebarLinks}>
              <li>
                <Link href="/pricing/implants">{t('sidebarCeramic')}</Link>
              </li>
              <li>
                <Link href="/pricing/implants">{t('sidebarBraces')}</Link>
              </li>
              <li>
                <Link href="/pricing/implants">{t('sidebarOther')}</Link>
              </li>
            </ul>
          </div>
        </div>
