...
const stories = [
  { nameKey: "s1Name" as const, originKey: "s1Origin" as const, storyKey: "s1Story" as const },
  { nameKey: "s2Name" as const, originKey: "s2Origin" as const, storyKey: "s2Story" as const },
  { nameKey: "s3Name" as const, originKey: "s3Origin" as const, storyKey: "s3Story" as const },
  { nameKey: "s4Name" as const, originKey: "s4Origin" as const, storyKey: "s4Story" as const },
  { nameKey: "s5Name" as const, originKey: "s5Origin" as const, storyKey: "s5Story" as const },
  { nameKey: "s6Name" as const, originKey: "s6Origin" as const, storyKey: "s6Story" as const },
];
