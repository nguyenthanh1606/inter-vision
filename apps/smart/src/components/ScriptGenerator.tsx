  ...
  return (
    <div className="config-section script-output">
      ...
      <p style={{ color: 'var(--text-2)', fontSize: 14, marginBottom: 16 }}>
        Copy this script tag and paste it before <code>&lt;/body&gt;</code> in your website HTML.
      </p>
      ...
      {/* Test locally */}
      <div style={{ marginTop: 20, padding: 16, background: 'var(--surface-2)', borderRadius: 'var(--radius-sm)' }}>
        <h4 style={{ fontSize: 14, fontWeight: 600, marginBottom: 8 }}>🧪 Test locally</h4>
        <p style={{ color: 'var(--text-2)', fontSize: 13 }}>
          1. Run <code>npx nx build-widget smart</code> to compile the widget<br />
          2. Serve <code>apps/smart/dist-widget/smart-popup.js</code> from any web server<br />
